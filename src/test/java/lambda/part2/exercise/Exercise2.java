...
public class Exercise2 {
    ...
    public void personHasNotEmptyLastNameAndFirstName() {
        Predicate<Person> validate = (p -> (p.getFirstName().length() != 0 && !p.getLastName().equals("")));
    ...
    public void personHasNotEmptyLastNameAndFirstNameUsingLogicalOperators() {
        Predicate<Person> personHasEmptyFirstName = p -> (p.getFirstName() == "");
        Predicate<Person> personHasEmptyLastName = p -> (p.getLastName().equals(""));
